    ...
    <section className="px-10 py-16">
      <div className="grid grid-cols-2 items-center justify-center mbl:flex mbl:flex-col-reverse">
        <div className="flex flex-col items-start justify-center gap-10 pl-10 mbl:items-center mbl:pl-0">
          <h2 className="text-6xl font-bold text-product-purple-500 mbl:text-5xl mbl:text-center mbl:mt-6">Bienal do Livro</h2>
          ...
          <button className="flex items-center justify-center px-16 py-4 bg-product-purple-500 text-white rounded-md text-xl font-medium transition-all hover:opacity-90 mbl:px-28">
            Saber mais
          </button>
        </div>
